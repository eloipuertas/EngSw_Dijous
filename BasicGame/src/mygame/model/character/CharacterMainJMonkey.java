...
public class CharacterMainJMonkey extends AbstractAppState
  ...
  private Node playerShape;private 
  Node rootNode = new Node("gameRoot");
  ...
  private AudioNode audio_footstep;
    ...
    //Spatial playerShapes = app.getAssetManager().loadModel("Models/Elephant/Elephant.mesh.xml");
    ...
    playerShape.setLocalScale(0.09f);
    playerShape.addControl(player);
    player.setPhysicsLocation(new Vector3f(0, 10, 0));
    
    bulletAppState.getPhysicsSpace().add(player);
    rootNode.attachChild(playerShape);
    initAudio();
  }
