...
/** Main Character JMonkey class. It contains all necessary methods
    in order to load, situate, move and run our character correctly.
    It has necessary methods for charge weapon and if it is required, shoot.
    It also contains buttons and listeners so that it makes its moves.
    In addition, it has ambient music and footsteps sound and Pause and Mute states.
...
public class CharacterMainJMonkey
	implements ActionListener, CharacterMainInterface {
         ...
         * It creates and loads our character. It initializes our listeners and keys and
        ...
        private void initAmbientAudio(){
                if(primeraVez){                             //
                        isPaused = false;  // set it isn't paused
...
*/
        ...
        /** Method which has our custom actions triggered by key presses.
         * We do not walk yet, we just keep track of the direction the user pressed. 
         * Arguments: string to compare: binding
                      boolean flag : value
                      and float */
        ...
        public void onAction(String binding, boolean value, float tpf) {
                ...
                else audio_footstep.pause(); // otherwise, pause sound
        }
		
    /**
     * Method with the main event loop--walking.
    ...
    /** Method which adds weapon on weapons list
        Argument: weapon instance created: weapon*/
    ...
    /** Shoot Listener
     Method and listener which performs shooting action in scenario whithin peephole and red mark.
     * It also and shows collision sceneario elements*/
    ...
    /** Method which creates a red mark as a sphere. 
        * Useful for test if weapon can shoot */
    ...
    /** Method which constructs a peephole that recreates our target shooting
        It points to the objective where our red sphere will go*/
