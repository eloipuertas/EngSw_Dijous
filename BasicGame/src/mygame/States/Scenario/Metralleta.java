 ...
 * @author Harpo
 */
public class Metralleta implements WeaponInterface {
    ...
    // constructor
    public Metralleta(SimpleApplication app, BulletAppState bulletAppState, Vector3f position, int munition, String id) {
        this.app = app;
